...
def run( ts_fnames, format, mapping, radix, orders, modname, fold, loo ):
    ...
    for order in orders:
        ...
        cv_engine = rp.cv.MultiCV( model_factory, training_sets, fold, passes, loo )
...
def main():
    ...
    run( ts_fnames, options.format, mapping, radix, orders, modname, fold, loo )
