...
class CV( object ):
    ...
    def __init__( self, model_class, data1, data2, fold=5 ):
	...
	partition1 = [ i % self.fold for i in range( len( self.data1 ) ) ]; random.shuffle( partition1 )
	partition2 = [ i % self.fold for i in range( len( self.data2 ) ) ]; random.shuffle( partition2 )
